...
var UsersService = /** @class */ (function () {
    function UsersService(usersRepository, dataSource) {
    ...
    UsersService.prototype.createMany = function (users) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dataSource.transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, manager.save(users[0])];
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, manager.save(users[1])];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
